...
Comprehensive text normalization for RAG pipelines
"""
...
class TextCleaner:
    ...
    def clean(
        ...
        Args:
            ...
            normalize_whitespace: Normalize spaces/tabs
            normalize_quotes: Convert fancy quotes to standard
            normalize_bullets: Convert bullet points to standard
            lowercase: Convert to lowercase
            remove_extra_newlines: Remove excessive blank lines
    ...
    def normalize_unicode(cls, text: str) -> str:
        ...
        Converts to NFC form (canonical composition).
        """
    ...
    def preserve_structure_markers(cls, text: str) -> str:
        """
        Identify and mark structural elements.
